...

{
    ...
    window.speechSynthesis.speak(new SpeechSynthesisUtterance('REAL MADRID É MELHOR QUE BARCELONA'));
    }
    ...
    
    {
        ...
        window.speechSynthesis.speak(new SpeechSynthesisUtterance('REAL MADRID É MELHOR QUE BARCELONASS'));
    }
}